...
REVIEWED_ORDER_FREE = (
    ...
    # LW-M7-39 DRM permission default, measured 2026-09-24.
    ('patches/android/no-adjust.patch', 'patches/android/drm-permission-default.patch', ('mobile/android/fenix/app/src/main/java/org/mozilla/fenix/utils/Settings.kt',), 'Candidate swapped immediately before this predecessor applies and every pair-shared path is byte-identical on 153.3.0esr (docs/android/evidence/lw-m7-39/ordering-swap.txt).'),
    ('patches/android/no-onboarding.patch', 'patches/android/drm-permission-default.patch', ('mobile/android/fenix/app/src/main/java/org/mozilla/fenix/utils/Settings.kt', 'mobile/android/fenix/app/src/test/java/org/mozilla/fenix/utils/SettingsTest.kt'), 'Candidate swapped immediately before this predecessor applies and every pair-shared path is byte-identical on 153.3.0esr (docs/android/evidence/lw-m7-39/ordering-swap.txt).'),
    ('patches/android/no-gms.patch', 'patches/android/drm-permission-default.patch', ('mobile/android/fenix/app/src/main/java/org/mozilla/fenix/utils/Settings.kt',), 'Candidate swapped immediately before this predecessor applies and every pair-shared path is byte-identical on 153.3.0esr (docs/android/evidence/lw-m7-39/ordering-swap.txt).'),
    ('patches/android/no-suggest.patch', 'patches/android/drm-permission-default.patch', ('mobile/android/fenix/app/src/main/java/org/mozilla/fenix/utils/Settings.kt', 'mobile/android/fenix/app/src/test/java/org/mozilla/fenix/utils/SettingsTest.kt'), 'Candidate swapped immediately before this predecessor applies and every pair-shared path is byte-identical on 153.3.0esr (docs/android/evidence/lw-m7-39/ordering-swap.txt).'),
    ('patches/android/search-config.patch', 'patches/android/drm-permission-default.patch', ('mobile/android/fenix/app/src/main/java/org/mozilla/fenix/utils/Settings.kt',), 'Candidate swapped immediately before this predecessor applies and every pair-shared path is byte-identical on 153.3.0esr (docs/android/evidence/lw-m7-39/ordering-swap.txt).'),
    ('patches/android/privacy-defaults.patch', 'patches/android/drm-permission-default.patch', ('mobile/android/fenix/app/src/main/java/org/mozilla/fenix/utils/Settings.kt', 'mobile/android/fenix/app/src/test/java/org/mozilla/fenix/utils/SettingsTest.kt'), 'Candidate swapped immediately before this predecessor applies and every pair-shared path is byte-identical on 153.3.0esr (docs/android/evidence/lw-m7-39/ordering-swap.txt).'),
    ('patches/android/cookie-banner-controls.patch', 'patches/android/drm-permission-default.patch', ('mobile/android/fenix/app/src/main/java/org/mozilla/fenix/utils/Settings.kt',), 'Candidate swapped immediately before this predecessor applies and every pair-shared path is byte-identical on 153.3.0esr (docs/android/evidence/lw-m7-39/ordering-swap.txt).'),
    ('patches/android/firefox-suggest-policy.patch', 'patches/android/drm-permission-default.patch', ('mobile/android/fenix/app/src/main/java/org/mozilla/fenix/utils/Settings.kt',), 'Candidate swapped immediately before this predecessor applies and every pair-shared path is byte-identical on 153.3.0esr (docs/android/evidence/lw-m7-39/ordering-swap.txt).'),
)
