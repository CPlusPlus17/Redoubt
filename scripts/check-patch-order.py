...
CONSTRAINTS = (
    ...
    ('patches/android/ubo-preinstall.patch', 'patches/android/cookie-banner-controls.patch', ('mobile/android/fenix/app/src/main/res/values/strings.xml',), 'Retain uBO before graphics before cookie controls. Moving uBO after cookie controls fails first in the graphics strings hunk; this is a chosen composition constraint, not an isolated intrinsic pair conflict (LW-M7-21 cookie-controls-order.json).'),
    ('patches/android/canvas-webgl-permissions.patch', 'patches/android/cookie-banner-controls.patch', ('mobile/android/fenix/app/src/main/java/org/mozilla/fenix/settings/quicksettings/QuickSettingsSheetDialogFragment.kt', 'mobile/android/fenix/app/src/main/java/org/mozilla/fenix/settings/trustpanel/TrustPanelFragment.kt', 'mobile/android/fenix/app/src/main/java/org/mozilla/fenix/settings/trustpanel/ui/ProtectionPanel.kt', 'mobile/android/fenix/app/src/main/res/values/strings.xml', 'mobile/shared/modules/geckoview/GeckoViewStorageController.sys.mjs'), 'Cookie controls use the graphics controls layout and strings context; applying cookie controls first fails in four shared UI files (LW-M7-21 cookie-controls-order.json).'),
...
REVIEWED_ORDER_FREE = (
    ...
    # LW-M7-21: scoped cookie-controls/Sync composition replay.
    ('patches/android/no-adjust.patch', 'patches/android/cookie-banner-controls.patch', ('mobile/android/fenix/app/src/main/java/org/mozilla/fenix/utils/Settings.kt',), 'Both orders apply with all other scoped predecessors retained and yield identical bytes in all 24 inputs (LW-M7-21 cookie-controls-order.json).'),
    ('patches/android/no-onboarding.patch', 'patches/android/cookie-banner-controls.patch', ('mobile/android/fenix/app/src/main/java/org/mozilla/fenix/utils/Settings.kt',), 'Both orders apply with all other scoped predecessors retained and yield identical bytes in all 24 inputs (LW-M7-21 cookie-controls-order.json).'),
    ('patches/android/no-gms.patch', 'patches/android/cookie-banner-controls.patch', ('mobile/android/fenix/app/src/main/java/org/mozilla/fenix/utils/Settings.kt', 'mobile/android/fenix/app/src/main/res/values/preference_keys.xml'), 'Both orders apply with all other scoped predecessors retained and yield identical bytes in all 24 inputs (LW-M7-21 cookie-controls-order.json).'),
    ('patches/android/no-crashreporter.patch', 'patches/android/cookie-banner-controls.patch', ('mobile/android/fenix/app/src/main/res/values/strings.xml',), 'Both orders apply with all other scoped predecessors retained and yield identical bytes in all 24 inputs (LW-M7-21 cookie-controls-order.json).'),
    ('patches/android/no-suggest.patch', 'patches/android/cookie-banner-controls.patch', ('mobile/android/fenix/app/src/main/java/org/mozilla/fenix/utils/Settings.kt',), 'Both orders apply with all other scoped predecessors retained and yield identical bytes in all 24 inputs (LW-M7-21 cookie-controls-order.json).'),
    ('patches/android/search-config.patch', 'patches/android/cookie-banner-controls.patch', ('mobile/android/fenix/app/src/main/java/org/mozilla/fenix/utils/Settings.kt',), 'Both orders apply with all other scoped predecessors retained and yield identical bytes in all 24 inputs (LW-M7-21 cookie-controls-order.json).'),
    ('patches/android/update-check.patch', 'patches/android/cookie-banner-controls.patch', ('mobile/android/fenix/app/src/main/java/org/mozilla/fenix/settings/SettingsFragment.kt', 'mobile/android/fenix/app/src/main/res/xml/preferences.xml'), 'Both orders apply with all other scoped predecessors retained and yield identical bytes in all 24 inputs (LW-M7-21 cookie-controls-order.json).'),
    ('patches/android/privacy-defaults.patch', 'patches/android/cookie-banner-controls.patch', ('mobile/android/fenix/app/src/main/java/org/mozilla/fenix/utils/Settings.kt',), 'Both orders apply with all other scoped predecessors retained and yield identical bytes in all 24 inputs (LW-M7-21 cookie-controls-order.json).'),
