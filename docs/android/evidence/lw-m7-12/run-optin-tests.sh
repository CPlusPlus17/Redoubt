#!/usr/bin/env bash
# Rerun full Fenix/AC after reviewed test-only corrections; preserve APK source identity.
set -euo pipefail
...
python3 "$work/repo/docs/android/evidence/lw-m7-21/stage-optin-fixture.py"
fixture="$work/evidence/test-fixture-optin-source"
if [[ -d "$evidence" ]]; then
