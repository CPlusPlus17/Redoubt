#!/usr/bin/env bash
# Full Fenix/AC after a production routing correction and test fixtures; new APK pending.
set -euo pipefail
...
fixture="$work/evidence/fenix-navigation-fixture-source"
[[ ! -e "$evidence" ]]
[[ $(cat "$work/evidence/fenix-navigation-diagnostic-20260909/build-exit.txt") == 0 ]]
