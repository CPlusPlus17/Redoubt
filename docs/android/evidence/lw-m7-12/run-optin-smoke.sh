...
python3 "$work/repo/docs/android/evidence/lw-m7-21/stage-optin-fixture.py" --check
...
sha256sum "$apk" scripts/android-smoke.sh scripts/android-graphics-smoke.py \
  scripts/android-pref-audit.sh docs/android/evidence/lw-m7-12/run-optin-smoke.sh \
