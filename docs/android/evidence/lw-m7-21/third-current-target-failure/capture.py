"""Read-only terminal capture of the third target suite for the165-file candidate."""
import datetime
import hashlib
import io
import json
...
checkpoint = work/'evidence/test-optin-recovery-checkpoint'
...
assert sha(manifest) == '659bf836ec885425b596bf077236190e8df30b2285df625ff3988c5dc93129b6'
...
capture = {}
for folder, prefix in [(evidence, 'target-tests'), (checkpoint, 'checkpoint'), (work/'evidence/test-fixture-optin-source', 'test-fixture-optin-source')]:
...
assert b'InvocationID=1c9c192370c140e2b3f711828d8f4de1' in capture['service.txt']
...
result = {
    'classification': 'FAIL full Fenix gate:609 classes/5517 tests,30 failures=18 environmental+3 known-real+9 unexpected; all146 component cases pass. Runtime did not run.',
    'invocation': '1c9c192370c140e2b3f711828d8f4de1',
