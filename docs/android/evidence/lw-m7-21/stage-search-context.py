#!/usr/bin/env python3
"""Stage the reviewed Fenix nullable-context correction after the APK retry failure."""
import hashlib
import json
import os
...
PARENT = '395ce6827e94f48cb634be86726d39b7e96f6e4fcb515173b2fff0865c34555d'
OVERLAY_FILES = {
...
def main():
    ...
    correction = repo/'docs/android/evidence/lw-m7-21/search-context-correction'
    ...
    evidence = WORK/'evidence/apk-search-context-source'
    parent = WORK/'evidence/apk-admission-copy-source/source-sha256.txt'
    require(sha(parent) == PARENT, 'admission-corrected parent source differs')
    rows = {}
    ...
    if evidence.exists():
        ...
        print('PASS existing Fenix context correction verified')
        return
    ...
    print('PASS staged Fenix context correction;165 exact source bindings and unchanged native AARs')
