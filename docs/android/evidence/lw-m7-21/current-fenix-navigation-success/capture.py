...
evidence = work/'evidence/fenix-navigation-tests'
...
assert sha(manifest) == '501d04614edbc847b416cd5b6f1dac42dd0728a63125a3d9902c90d07a579c8b'
...
capture = {}
for folder, prefix in [(evidence, 'target-tests'), (work/'evidence/fenix-navigation-fixture-source', 'fenix-navigation-fixture-source')]:
...
unit = 'redoubt-fenix-navigation-tests-20260909.service'
...
assert b'InvocationID=98e7f2d2d31f4b318ba25d00c04fff54' in capture['service.txt']
...
result = {
    'classification': 'PASS actual full Fenix allowance and fresh coverage gates, with all146 selected component cases. New APK build and runtime still require separate evidence.',
    'invocation': '98e7f2d2d31f4b318ba25d00c04fff54',
