...
with no skips or errors (`evidence/lw-m7-21/fenix-navigation-correction/`). A new
full suite is running on the167-file manifest `501d0461…`; new APK compilation
and runtime checks remain pending. Later permission persistence, explicit
