...
(`evidence/lw-m7-21/current167-apk-checkpoint/`). Fresh emulator runtime is running
on its x86_64 APK `4391d56d…`; no runtime verdict is claimed yet. Later permission persistence, explicit
