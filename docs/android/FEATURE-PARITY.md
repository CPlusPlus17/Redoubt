...
translations, Sync, cookie controls and Suggest admission. APK compilation and
full Fenix/target suites remain pending. Later permission persistence, explicit
