...
**Where this stood at the end of 2026-09-06:** E1, E2, E4 and E5 met; E3 partly (five
checks green on the shipping artifact, two red — `--first-run-capture` for the reason in
E12, and `--check-no-suggest` because its capture-side positive control cannot see a
search that demonstrably runs); E6 to E12 open, and E7 to E10 need a person. The device evidence is in `docs/android/evidence/lw-m7-06/`, which also
