...
runner can still read the key. The recorded owner exception and measured QEMU
boundary address those separately. No release key or passphrase was used by this
